...
public class InstructionSequenceTests
{
    ...
    public void Disassembler_HandlesJmpSequence_Correctly()
    {
        ...
        var codeBuffer = new byte[] { 0x7D, 0x05, 0x83, 0xC5, 0x18, 0xEB, 0x03, 0x83, 0xC5, 0xB8, 0x8B, 0x56, 0x04 };
    ...
    public void Disassembler_HandlesAddSequence_Correctly()
    {
        ...
        var codeBuffer = new byte[] { 0x7d, 0x05, 0x83, 0xC5, 0x18, 0xEB, 0x03, 0x83, 0xC5, 0xB8, 0x8B, 0x56, 0x04, 0x8A, 0x02, 0x8D, 0x4A, 0x18 };
