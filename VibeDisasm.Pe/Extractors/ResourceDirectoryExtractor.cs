...
namespace VibeDisasm.Pe.Extractors
{
    ...
    /// </summary>
    public class ResourceDirectoryExtractor
    {
        /// <summary>
        /// Extracts resource directory information from a PE file
        /// </summary>
        ...
        public ResourceDirectoryInfo? Extract(RawPeFile rawPeFile)
        {
            if (rawPeFile == null)
            {
                throw new System.ArgumentNullException(nameof(rawPeFile));
            }
