...
public class XchgInstructionTests
{
    ...
    public void XchgEaxRegHandler_DecodesNopSequence_Correctly()
    {
        ...
        var codeBuffer = new byte[] { 0x90, 0x90, 0x90, 0x91 };
