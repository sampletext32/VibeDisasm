...
public class UnitTest1
{
    ...
    {
        var typeArchiveStorage = new TypeArchiveStorage(new NullLogger<TypeArchiveStorage>());

        var analyser = new PeAnalyser(typeArchiveStorage, new NullLogger<PeAnalyser>());
