    ...
    public static RuntimeTypeArchive CreateBuiltinArchive()
    {
        ...
        archive.AddType(
            new RuntimePrimitiveType(
                ...
                "undefined",
                1
            ).WithInterpreter(InterpretBase.AsUint())
        );
        archive.AddType(
            new RuntimePrimitiveType(
                ...
                "char",
                1
            ).WithInterpreter(InterpretBase.AsChar())
        );
        archive.AddType(
            new RuntimePrimitiveType(
        ...
        archive.AddType(
            new RuntimePrimitiveType(
                ...
                "int8_t",
                1
            ).WithInterpreter(InterpretBase.AsInt())
        );
        archive.AddType(
            new RuntimePrimitiveType(
        ...
        archive.AddType(
            new RuntimePrimitiveType(
                ...
                "float",
                4
            ).WithInterpreter(InterpretBase.AsFloat())
        );
        archive.AddType(
            new RuntimePrimitiveType(
        ...
        archive.AddType(
            new RuntimePrimitiveType(
                ...
                "bool",
                1
            ).WithInterpreter(InterpretBase.AsBool())
        );
    ...
    public static RuntimeTypeArchive CreateWin32Archive(RuntimeTypeArchive builtinArchive)
    {
        ...
        var imageFileHeader = archive.AddType(
            new RuntimeStructureType(
                ...
                "IMAGE_FILE_HEADER",
                [
                    new RuntimeStructureTypeField(wordType, "Machine"),
                    new RuntimeStructureTypeField(wordType, "NumberOfSections"),
                    new RuntimeStructureTypeField(dwordType, "TimeDateStamp")
                        .WithInterpreterOverride(InterpretBase.AsTimestamp()),
                    new RuntimeStructureTypeField(dwordType, "PointerToSymbolTable"),
                    new RuntimeStructureTypeField(dwordType, "NumberOfSymbols"),
                    new RuntimeStructureTypeField(wordType, "SizeOfOptionalHeader"),
                    new RuntimeStructureTypeField(wordType, "Characteristics"),
                ]
            )
        );
        ...
        var charType = builtinArchive.FindRequiredType("char");
        var imageSectionHeaderNameType = archive.AddType(
            new RuntimeArrayType(new Guid("985216b7-7acb-4d21-af24-7fa9ea0ac07c"), "win32", charType, 8)
        );

        archive.AddType(
            new RuntimeStructureType(
                new Guid("7f707f02-b066-4c09-8301-5ae2beec2e10"),
                "win32",
                "IMAGE_SECTION_HEADER",
                [
                    new RuntimeStructureTypeField(imageSectionHeaderNameType, "Name")
                        .WithInterpreterOverride(InterpretBase.AsAString()),
                    new RuntimeStructureTypeField(dwordType, "VirtualSize"),
                    new RuntimeStructureTypeField(dwordType, "VirtualAddress"),
                    new RuntimeStructureTypeField(dwordType, "SizeOfRawData"),
                    new RuntimeStructureTypeField(dwordType, "PointerToRawData"),
                    new RuntimeStructureTypeField(dwordType, "PointerToRelocations"),
                    new RuntimeStructureTypeField(dwordType, "PointerToLinenumbers"),
                    new RuntimeStructureTypeField(wordType, "NumberOfRelocations"),
                    new RuntimeStructureTypeField(wordType, "NumberOfLinenumbers"),
                    new RuntimeStructureTypeField(dwordType, "Characteristics")
                ]
            )
        );
